...
<title>Reset Password - iPaint</title>
...
<div class="relative z-10 flex flex-col md:flex-row w-full max-w-6xl bg-white rounded-3xl shadow-2xl overflow-hidden mx-4 sm:mx-8 lg:mx-16">
  ...
  <div class="w-full md:w-1/2 hidden md:flex flex-col items-center justify-center bg-gradient-to-br from-pink-400 via-yellow-300 to-indigo-400 p-4 md:p-6 relative">
      ...
      <h2 class="text-white text-2xl sm:text-3xl font-bold mt-6 text-center">Reset Your Password</h2>
      <p class="text-white text-center mt-2 text-sm sm:text-base">
          Enter a new password to secure your iPaint account.
      </p>
  </div>
  ...
  <div class="w-full md:w-1/2 p-6 sm:p-8 md:p-10 flex flex-col justify-center">
      <form action="#" method="POST" class="space-y-6">
        ...
        <!-- Instruction text -->
          <p class="text-center text-gray-600 mb-4">Please enter your new password below to reset your iPaint account password.</p>

          <!-- Email (Auto-fill) -->
          <div class="relative floating-label">
              <input type="email" name="email" id="email" value="{{ $email ?? '' }}" placeholder=" " readonly class="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-100 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-pink-400 transition duration-300">
        ...
        <div class="relative floating-label">
            ...
            <button type="button" id="toggleConfirmPassword" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-700 focus:outline-none">
                <svg id="eyeConfirmOpen" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-1.274 4.057-5.065 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                </svg>
                <svg id="eyeConfirmClosed" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.477 0-8.268-2.943-9.542-7a10.055 10.055 0 012.658-3.848M6.223 6.223A9.965 9.965 0 0112 5c4.477 0 8.268 2.943 9.542 7a9.96 9.96 0 01-1.666 3.042M3 3l18 18"/>
                </svg>
            </button>
        </div>
          ...
          <!-- Reset Button -->
          <button type="submit" class="w-full bg-gradient-to-r from-pink-400 via-yellow-300 to-indigo-400 hover:from-pink-500 hover:via-yellow-400 hover:to-indigo-500 text-white font-semibold py-3 rounded-lg transition duration-500">Reset Password</button>
